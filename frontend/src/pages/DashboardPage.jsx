...
export default function DashboardPage({
  ...
  return (
    <SectionCard
      title="Dashboard"
      subtitle="Resumo do inventário, atividade recente na plataforma e atalhos. O botão Histórico abre o registo completo da tua conta; a aba Logs é para eventos técnicos na rede."
      rightAction={
